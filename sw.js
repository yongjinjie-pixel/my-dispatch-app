...
const FILES = [
  ...
  shellUrl(`./app.js?v=${BUILD}`), shellUrl(`./scheduler.js?v=${BUILD}`), shellUrl(`./manifest.json?v=${BUILD}`),
  shellUrl("./initial-company-core.json"), shellUrl("./initial-company-master.json"), shellUrl("./initial-company-orders.json"), shellUrl("./initial-company-assignments.json"), shellUrl("./initial-company-trip-logs.json"),
