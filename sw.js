...
const FILES = [
  ...
  shellUrl(`./app.js?v=${BUILD}`), shellUrl("./scheduler.js"), shellUrl(`./manifest.webmanifest?v=${BUILD}`),
  shellUrl("./icons/icon-192.png"), shellUrl("./icons/icon-512.png"),
];
