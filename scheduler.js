...
export function defaultState() {
  ...
  return { schemaVersion: 9, companyName: "My Transport Dispatch", notices: ["Operasi JPJ: check documents, tyre condition and load cover before moving."], trucks, sources, materials, customers, orders, assignments: [], tripLogs: [], quarryTripLogs: [], quarryEnquiries: [], sandpitEntries: [], sandpitPermits: [], dailyFleetPlans: [], makeUps: [], settings: { storageMode: "phone-only", lastBackupAt: "", sandpitPermitCost: 0, themePreference: "system", screenOrientation: "auto" }, updatedAt: now };
}
