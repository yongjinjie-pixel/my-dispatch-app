...
export function defaultState() {
  ...
  return { schemaVersion: 16, companyName: "My Transport Dispatch", notices: ["Operasi JPJ: check documents, tyre condition and load cover before moving."], trucks, sources, materials, customers, orders, assignments: [], tripLogs: [], extraTripLogs: [], quarryTripLogs: [], quarryEnquiries: [], quarryRequests: [], quarryOnlyEntries: [], sandpitEntries: [], sandpitPermits: [], dailyFleetPlans: [], dailyTruckStatuses: [], messageRemarks: [], driverAbsences: [], planLocks: [], makeUps: [], settings: { storageMode: "phone-only", lastBackupAt: "", sandpitPermitCost: 0, themePreference: "system", screenOrientation: "auto" }, updatedAt: now };
}
...
export function ensureState(raw) {
  ...
  state.schemaVersion = 16; return state;
}
